...
export default defineConfig({
	...
	themeConfig: {
		...
		editLink: {
			pattern: 'https://github.com/monolikit/monolikit/edit/main/docs/:path',
			text: 'Suggest changes to this page',
		},

		socialLinks: [
			{ icon: 'twitter', link: `https://twitter.com/${twitter}` },
			{ icon: 'github', link: 'https://github.com/monolikit/monolikit' },
		],
			...
			'/guide/': [
				{
					...
					items: [
						{ text: 'What is Monolikit', link: '/what-is-monolikit' },
