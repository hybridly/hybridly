...
test('pascal-case component names trigger deprecation warnings', function () {
    ...
    'Since hybridly/laravel 0.7: Passing component names with uppercase to Hybridly is deprecated, you should use kebab case instead (Received: dashboard::ShowDashboard, expected: dashboard::show-dashboard)',
);
